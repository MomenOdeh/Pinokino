...
Original file is located at
    https://colab.research.google.com/drive/1VzxCG1ZWT2tVqs_N1POXKEULogiCRtap
"""
...
real = pd.read_csv('/content/gdrive/My Drive/fake-news/True.csv')
fake = pd.read_csv('/content/gdrive/My Drive/fake-news/Fake.csv')
